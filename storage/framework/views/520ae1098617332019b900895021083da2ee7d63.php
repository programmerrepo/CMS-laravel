<?php echo $__env->make('include.header', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<div class="navbar navbar-fixed-top custom-navbar" role="navigation">
	<div class="container">
		...
		<div class="navbar-header">
			...
			<a href="#" class="navbar-brand"><?php echo e($blog_Name); ?></a>
		</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-12 col-sm-12">
				...
				<a href="<?php echo e(route('login')); ?>" class="btn btn-lg btn-default smoothScroll wow fadeInUp hidden-xs" data-wow-delay="2.3s">LOGIN</a>
				<a href="<?php echo e(route('register')); ?>" class="btn btn-lg btn-danger smoothScroll wow fadeInUp" data-wow-delay="2.3s">REGISTER NOW</a>
			</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="wow fadeInUp col-md-6 col-sm-6" data-wow-delay="0.6s">
				<h3><?php echo e($kpost -> title); ?></h3>
				<p><?php echo e($kpost -> content); ?></p>
				<p><?php echo e($kpost -> created_at); ?></p>
			</div>
					
			<div class="wow fadeInUp col-md-6 col-sm-6" data-wow-delay="0.9s">
				<img src="<?php echo e($kpost -> featured); ?>" class="img-responsive" alt="Overview">
			</div>
...
<section id="speakers" class="parallax-section">
	<div class="container">
     ...
     <?php $__currentLoopData = $man; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nameU): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
   
				<div class="item wow fadeInUp col-md-3 col-sm-3" data-wow-delay="0.9s">
					<div class="speakers-wrapper">
						<img src="images/speakers-img1.jpg" class="img-responsive" alt="speakers">
							<div class="speakers-thumb">
								<h3><?php echo e($nameU -> name); ?></h3>
								<h6>E-mail: <?php echo e($nameU -> email); ?></h6>
							</div>
					</div>
				</div>
...
<section id="program" class="parallax-section">
    ...
    <?php $__currentLoopData = $name; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<li><a href="#<?php echo e($nam->name); ?>" aria-controls="<?php echo e($nam -> name); ?>" role="<?php echo e($nam -> name); ?>" data-toggle="tab"><?php echo e($nam->name); ?></a></li>
     ...
     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
				...
				<div class="<?php echo e($nam -> name); ?>-content">
     <?php $__currentLoopData = $name; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
 					<div role="<?php echo e($nam -> name); ?>" class="<?php echo e($nam -> name); ?>-pane " id="<?php echo e($nam -> name); ?>">
						...
						<div class="col-md-10 col-sm-10">
							...
							<h3>Introduction to Design <?php echo e($nam -> name); ?></h3>
